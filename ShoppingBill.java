    ...
    {  
        public static void main(String args[])   
            {  
                ...
                System.out.println("\t\t\t\t\t "+"  "+"Jonrets Grocery Shop");  
                System.out.println("\t\t\t\t\t24/7 Valenzuela Branch");  
                System.out.println("\t\t\t\t\t"  +"    " +"Happy Shopping!");  
                System.out.println("GSTIN: 03AWBPP8756K592"+"\t\t\t\t\t\t\tContact: (+63) 9988776655");  
                ...
                System.out.println("Date: "+formatter.format(date)+"  "+days[calendar.get(Calendar.DAY_OF_WEEK) - 1]+"\t\t\t\t\t\t (+63) 9998887770");  
